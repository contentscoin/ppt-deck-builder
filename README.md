...
The scripts are helpers, not a substitute for design judgment. The skill still requires the agent to inspect source material, make evidence-safe asset decisions, apply design rules, and perform render QA.
